...
var zoom = (function () {
    ...
    function pan() {
        ...
        // Up
        if (mouseY < rangeY) {
            window.scroll(scrollOffset.x, scrollOffset.y - (1 - (mouseY / rangeY)) * (14 / level) // Down
            );
        ...
        // Left
        if (mouseX < rangeX) {
            window.scroll(scrollOffset.x - (1 - (mouseX / rangeX)) * (14 / level), scrollOffset.y // Right
            );
    ...
    return {
        ...
        to: function (options) {
            ...
            // Due to an implementation limitation we can't zoom in to another element
            ...
            if (level !== 1) {
                ...
                if (options.scale > 1) {
                    ...
                    if (options.pan !== false) {
                        ...
                        // Wait with engaging panning as it may conflict with the zoom transition
